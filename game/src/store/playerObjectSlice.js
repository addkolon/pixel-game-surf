     ...
     switch (direction) {
      ...
      case "slowdown":
       ...
       if (state.board.speedDown > 0) {
        state.board.speedDown = roundIt(state.board.speedDown - accSpeed);
       }
       state.board.y = roundIt(state.board.y + state.board.speedDown);
      ...
      case "slowright":
       ...
       if (state.board.speedRight > 0) {
        state.board.speedRight = roundIt(state.board.speedRight - accSpeed);
       }
      ...
      case "slowleft":
       ...
       if (state.board.speedLeft > 0) {
        state.board.speedLeft = roundIt(state.board.speedLeft - accSpeed);
       }
